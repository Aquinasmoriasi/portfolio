...
const Home = () => (
  <>
    ...
    <section
      id="homepage"
      className="d-flex align-items-center min-vh-100 m-0"
    >
      <div className="container ps-5 border-3 d-flex">
        <div>
          ...
          <Fade bottom>
            <p className="description text-light">
              ...
              Look through some of my work and experience it! If you like what you
        ...
        <ul className="contact-icons list-unstyled">
          ...
          <li>
            <a href="https://angel.co/u/aquinas-moriasi">
              <i className="fa fa-angellist" aria-hidden="true" />
            </a>
          </li>
          <li>
            <a href="https://twitter.com/aquinas747/">
              <i className="fa fa-twitter-square" aria-hidden="true" />
            </a>
          </li>
          <li>
            <a href="https://medium.com/@aquinasmoriasi/">
              <i className="bi bi-medium" />
            </a>
          </li>
          <li>
            <a href="mailto:aquinasmoriasi@gmail.com">
